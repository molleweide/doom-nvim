...
doom.modules.features.whichkey.settings.plugins.marks = true
doom.modules.features.whichkey.settings.plugins.registers = true
doom.modules.features.whichkey.settings.plugins.presets.operators = true
...
doom.use_keybind({
  -- need to add all leader levels in order to show in whichkey?
  { '<leader>ss', { -- Names this group in whichkey "+user"
    { 'y', [[ :%s/<C-r><C-w>/<C-r>0/g<CR> ]], name = 'r all w/last yank' }
  }},
})
