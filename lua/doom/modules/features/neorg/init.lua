...
--
--
-- TEST: https://github.com/3rd/diagram.nvim
-- > This use `mermaid` which alows for showing extremely nice flow charts etc.
    ...
    load = {
        ...
        ["core.dirman"] = {
            config = {
                ...
                -- FIX: Both these have been removed. use Neovim autochdir opt instead.
                -- autodetect = true,
                -- autochdir = true,
            },
        },
        ...
        {
            {
                ...
                name = "+open/close",
                {
                    ...
                    name = "+neorg",
                    {
                        ...
                        -- TODO: add test func for vim.ui select workspaces -> add new notes.
