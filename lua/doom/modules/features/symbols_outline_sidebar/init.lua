...
symbols.configs = {}
symbols.configs["outline.nvim"] = function()
  -- vim.g.symbols_outline = doom.features.symbols.settings
  require("outline").setup(doom.features.symbols_outline_sidebar.settings.config)
end

symbols.binds = {
  { "<F2>", ":Outline<CR>", name = "Toggle symbols outline" },
  {
    "<leader>",
    name = "+prefix",
    {
      {
        ...
        name = "+open/close",
        {
          { "s", "<cmd>Outline<CR>", name = "Symbol outline" },
        },
      },
    },
  },
