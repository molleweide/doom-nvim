...
---@brief [[
--
-- This module has helpers (used by the dui.operations modules), which interact with
-- modules.lua and the respective target doom module dir. Creating, pruning, moving, etc.
--
---@brief ]]
