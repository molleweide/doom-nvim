  ...
  local function mod_browser_operate_on_current_dir(path_to)
    vim.ui.input(
      ...
      function(module_target_name)
        ...
        local target_module_init_file = target_module_dir / "init.lua"
        ...
        if not target_module_init_file:exists() then
          ...
          if ok then
            ...
            -- FIX: I need to async ensure that the file has been properly written
            --
            -- optionally edit / split v|h / etc..
            if false then -- optionally edit file
