...
nest.description = [[
Caches doom keybinds in hidden global table and exposes a picker that allows user
to navigate and manage doom keybinds. It does NOT create the keybinds - creation
happens in [core.modules]
]]
