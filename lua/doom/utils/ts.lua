...
local ts_query_templates = {
  root_mod_comments_and_single_str = [[]],
}



-- TODO: MOVE INTO `MODULES/UTILS`
--
--
-- return ranges for the module, or false -> not found
ts.root_modules_get_mod_state = function(section, module_name)

  -- TODO: inject lisp here
  --
  -- i believe [] has to be used here to allow for either comment or field
  ...
  (table_constructor
      (field
        ...
        value: (table_constructor
              ; TODO: Experiment here to see what actually comes out when iter captures.
