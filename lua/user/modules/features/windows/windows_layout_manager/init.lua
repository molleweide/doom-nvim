...
window_layouts.packages = {
  ["edgy.nvim"] = {
    "folke/edgy.nvim",
  },
}

window_layouts.configs = {}

window_layouts.configs["edgy.nvim"] = function()
  require("edgy").setup(doom.modules.features.windows.windows_layout_manager.settings.defaults)
end

-- window_layouts.binds = {
--   "<leader>",
--   name = "+prefix",
--   {
--     {
