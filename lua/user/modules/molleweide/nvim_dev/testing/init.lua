...
-- Adds functionality related to running tests and testing neovim
--
-- The current code is taken from TJs repo.
...
nvim_dev.run_this_test = function()
  ...
  local test_filter = string.sub(line, it_start + 1, it_finish - 1):gsub("'", ""):gsub('"', "")
